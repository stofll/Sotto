...
info "Everything below is .github/workflows/release.yml, on the tag push."
info "Nothing here is run by hand; the matrix lives in the workflow."
echo ""
...
info "Publishing is the moment latest.json goes live for the updater."
echo ""
