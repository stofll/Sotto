...
asset name from the release (for example, `Sotto_0.0.1_x64-setup.exe` on Windows
...
```bash
artifact='Sotto_0.0.1_x64-setup.exe' # replace with your downloaded asset name
