...
1. Agree on the release version, update the package metadata, and prepare user-facing release notes using the [release notes template](RELEASE.md#whats-new-template).
