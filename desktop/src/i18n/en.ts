...
export const en: Record<string, string | string[]> = {
  ...
  "Сбросить замеры": "Reset measurements",
  "Скорость пока неизвестна. Оценка появится после распознаваний или эталонных тестов.": "Speed is not yet known. An estimate will appear after transcriptions or reference tests.",
  "Не удалось оценить запас памяти.": "Memory headroom could not be estimated.",
  "GPU выбран, но фактическое ускорение не подтверждено.": "GPU is selected, but actual acceleration has not been confirmed.",
  "На вашем компьютере: {p0}–{p1} с аудио — обычно {p2} с обработки. Записей: {p3}.": "On your computer: {p0}–{p1}s of audio typically takes {p2}s to process. Samples: {p3}.",
  "Первые распознавания после загрузки модели.": "First transcriptions after loading the model.",
  "Скорость нестабильна; для шкалы пока недостаточно согласованных замеров.": "Speed varies too much to display a reliable rating yet.",
  "Сравнительная скорость по эталонным тестам: {p0}. Скорость на вашем компьютере может отличаться.": "Relative speed from reference tests: {p0}. Speed on your computer may differ.",
  "Уточняем скорость: {p0} из 5 сопоставимых записей.": "Learning your speed: {p0} of 5 comparable samples.",
  "Модель уже в памяти. Дополнительная загрузка не требуется; запас для распознавания зависит от длины аудио.": "The model is already in memory. No additional load is needed; inference headroom depends on audio length.",
  "Не удалось проверить запас видеопамяти. Это не запрещает запуск модели.": "GPU memory headroom could not be checked. You can still run the model.",
  "Может не хватить памяти с учётом запаса для системы. Можно освободить память или выбрать модель меньше.": "Memory may be insufficient after allowing headroom for the system. Free some memory or choose a smaller model.",
  "Вероятно, памяти достаточно. Больше заполнения — больше свободного запаса.": "Memory is likely sufficient. More fill means more headroom.",
  "Оценка RAM: {p0} ГБ; доступно сейчас: {p1} ГБ.": "Estimated RAM: {p0} GB; currently available: {p1} GB.",
  "Последняя загрузка модели не удалась. Попробуйте снова.": "The last model load failed. Try again.",
  "Не удалось сбросить оценку. Попробуйте снова.": "Could not reset the assessment. Try again.",
  ...
  "В активных наборах: {count}": "In enabled sets: {count}",
  ...
  "Откройте набор, чтобы посмотреть термины. Включённые наборы работают вместе.": "Open a set to view its terms. Enabled sets work together.",
  ...
  "Термины": "Terms",
  "Включить набор после сохранения": "Enable this set after saving",
