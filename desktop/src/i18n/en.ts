...
export const en: Record<string, string | string[]> = {
  ...
  "Ярлык в меню «Пуск»": "Start menu shortcut",
  "Укажите полный путь к папке, например D:\\Apps\\Sotto.": "Enter a full folder path, such as D:\\Apps\\Sotto.",
  "Выберите пустую папку для установки Sotto.": "Choose an empty folder to install Sotto.",
  "При обновлении используется папка установленной Sotto.": "Updates use the folder where Sotto is already installed.",
  "Не удалось открыть выбор папки. Введите путь вручную.": "Could not open the folder picker. Enter the path manually.",
  "Повторить попытку": "Try again",
  "Светлая тема": "Light theme",
  "Тёмная тема": "Dark theme",
  "Установить": "Install",
  "Сменить язык": "Switch language",
  "В этой сборке нет установочного пакета.": "This build does not contain an installation package.",
  ...
  "Sotto установлено": "Sotto is installed",
  "Не удалось установить Sotto": "Could not install Sotto",
  "Устанавливаем Sotto": "Installing Sotto",
  "Всё готово. Можно начинать.": "Everything is ready. Let's get started.",
  "Подготавливаем приложение для вашего компьютера.": "Preparing the application for your computer.",
  "Установка Sotto": "Installing Sotto",
  "Подготовка файлов": "Preparing files",
  "Установка приложения и ярлыков": "Installing the application and shortcuts",
  "Дождитесь завершения. Это окно можно свернуть.": "Please wait until installation finishes. You can minimize this window.",
  "Запустить Sotto": "Launch Sotto",
  "Демонстрация · установка не выполняется": "Preview · no installation takes place",
  "Об установке": "About this installation",
  "Приложение будет установлено для текущего пользователя. Настройки, история и модели сохраняются. Модель распознавания можно выбрать после запуска.": "The application will be installed for the current user. Settings, history and models are preserved. Choose a speech model after launching.",
  "Оценка по сравнительным тестам; на вашем компьютере скорость может отличаться.": "Based on comparative tests; speed on your computer may differ.",
  "Низкая относительная скорость.": "Low relative speed.",
  "Средняя относительная скорость.": "Medium relative speed.",
  "Высокая относительная скорость.": "High relative speed.",
  "Пока нет сравнительного замера для этой модели.": "No comparative benchmark is available for this model yet.",
  "Для скачивания нужно {p0} ГБ на диске, свободно {p1} ГБ. Освободите место и вернитесь в окно приложения.": "Download requires {p0} GB of disk space; {p1} GB available. Free up space and return to the app window.",
  "Не хватает места": "Not enough space",
  "Низкая": "Low",
  "Средняя": "Medium",
  "Высокая": "High",
  ...
  "Графит": "Graphite",
  "Для отмены наведите указатель на бусину.": "Hover over the bead to cancel.",
  "Лагуна": "Lagoon",
  "Насыщенность": "Saturation",
  "Не удалось сохранить настройки оверлея. Попробуйте ещё раз.": "Could not save overlay settings. Try again.",
  ...
  "Цвет кнопок, выделения и активных элементов во всём приложении. Цвет оверлея настраивается отдельно, в разделе «Оверлей».": "The colour of buttons, selection and active elements across the app. The overlay colour is set separately, in the Overlay section.",
  "Сбросить отступ": "Reset offset",
  "Вернуть отступ по умолчанию — {p0} px": "Return the offset to the default of {p0} px",
  "Цвет оверлея": "Overlay colour",
  "Щёлкните по месту на экране, где должен появляться оверлей.": "Click the spot on the screen where the overlay should appear.",
  "По центру": "Center",
  ...
  "двойные запятые и запятая в начале текста": "doubled commas and a comma at the start of the text",
  "Исправлять опечатки": "Correct spelling",
  "при русском языке диктовки: однозначные исправления по встроенному словарю, без LLM": "when dictation language is Russian: unambiguous corrections using a built-in dictionary, without an LLM",
  ...
  "паузы учтены частично": "pauses partially accounted for",
  "Оценка ручного набора минус полная длительность аудио и обработка. Замеров речи за этот период нет.": "Estimated typing time minus full audio duration and processing. No speech measurements for this period.",
  "Паузы оценены в {p0} из {p1} записей. Остальные учтены по полной длительности аудио.": "Pauses measured in {p0} of {p1} recordings. The rest use their full audio duration.",
  ...
  "активный термин|активных термина|активных терминов": ["active term", "active terms"],
  "Удаляет из распознанного текста слова-паразиты, повторы и лишние пробелы, исправляет пунктуацию. Применяются только включённые правила.": "Removes filler words, repetitions and extra spaces from recognized text, and fixes punctuation. Only enabled rules are applied.",
  "Заменяет найденные слова и фразы по вашим правилам: например, «щас» на «сейчас». Учитывает настройки регистра и совпадения каждого правила.": "Replaces matching words and phrases using your rules, such as “gonna” with “going to”. Respects each rule’s case and matching settings.",
  "Помогает исправлять похожие написания имён, брендов и терминов после распознавания. Активные наборы работают вместе; Whisper также использует их как подсказку. Это не точная замена текста.": "Helps correct similar spellings of names, brands and terms after recognition. Active sets work together; Whisper also uses them as hints. This is not an exact text replacement.",
  ...
  "Мои слова": "My words",
  "Термины разработки: инструменты, языки и рабочие процессы.": "Development terms: tools, languages and workflows.",
  "Форматирование выключено: словари не исправляют текст. Подсказка Whisper продолжает работать.": "Formatting is off: dictionaries do not correct text. Whisper hints still apply.",
  "Не удалось загрузить или сохранить словари. Изменения не применены.": "Could not load or save dictionaries. Changes were not applied.",
  "Наборов пока нет. Создайте набор для своих имён и терминов.": "No sets yet. Create a set for your names and terms.",
  "Встроенный": "Built-in",
  ...
  "Редактор набора": "Set editor",
  "Закрыть без сохранения изменений?": "Close without saving changes?",
  "Вернуться": "Go back",
  "Не сохранять": "Discard changes",
  "Словари изменились в другом окне. Скопируйте несохранённый текст и откройте набор заново.": "Dictionaries changed in another window. Copy any unsaved text and reopen the set.",
  "Название набора": "Set name",
  "Описание (необязательно)": "Description (optional)",
  "Термины": "Terms",
  "Поиск по набору": "Search this set",
  "В наборе пока нет терминов": "This set has no terms yet",
  "Эти термины слишком короткие для коррекции текста, но остаются в подсказке Whisper:": "These terms are too short for text correction, but remain in Whisper hints:",
  "Написание термина «{term}»": "Spelling for “{term}”",
  "Выбранное написание используется во всех активных наборах. Регистр результата также зависит от исходного текста.": "The chosen spelling applies across enabled sets. Output capitalization also depends on the original text.",
  "Удалить набор «{name}»? Его содержимое будет потеряно.": "Delete “{name}”? Its contents will be lost.",
  "Создать копию": "Create copy",
  "Загрузка…": "Loading…",
  "Не удалось открыть историю.": "Could not open history.",
  "Если перезагрузка не помогла, полностью закройте Sotto и запустите снова.": "If reloading does not help, quit Sotto completely and start it again.",
  "Перезагрузить": "Reload",
  "Повторить": "Retry",
  "Редактировать": "Edit",
  "Сохранение…": "Saving…",
  "эээ ну я я щас обсуждаю тайпскрипт, смайл, потом отправлю мой мейл": "i i am gonna discuss type script, smiley, then send my email",
  "щас": "gonna",
  "сейчас": "going to",
