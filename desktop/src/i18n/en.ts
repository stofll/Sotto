...
export const en: Record<string, string | string[]> = {
  ...
  "Пока нет оценки скорости для этой модели.": "No speed estimate is available for this model yet.",
  "Пока не удалось определить, хватит ли памяти для этой модели.": "We could not determine whether there is enough memory for this model.",
  "Быстрая: короткое ожидание после записи.": "Fast: a short wait after recording.",
  ...
  "Памяти должно хватить для работы модели.": "There should be enough memory to run this model.",
  "Нужно примерно {p0} ГБ оперативной памяти.": "Requires about {p0} GB of RAM.",
  "Сейчас свободно: {p0} ГБ.": "Currently free: {p0} GB.",
};
