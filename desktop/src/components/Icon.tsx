...
export function Icon({ name, size = 16, ...rest }: IconProps) {
  ...
  switch (name) {
    ...
    // искр вокруг диагонали читались как каша и ничего не говорили о тексте.
    ...
    // Корзина: крышка на всю ширину, а корпус — трапеция от 4.5 до 13.4 по
    // высоте. Прежняя версия читалась сплюснутой, потому что ручка занимала
    // всего 1.5 единицы и корпус начинался почти от крышки.
    ...
    // Боковая панель: окно с закрашенным левым рельсом. Раньше сворачивание
    // рисовалось одинокой «птичкой» влево — тем же глифом, каким везде
    // обозначают «назад», и её так и читали.
