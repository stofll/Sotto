...
LangString sottoWelcomeText ${LANG_RUSSIAN} "${PRODUCTNAME} распознаёт вашу речь и вставляет готовый текст в активное окно.$\r$\n$\r$\nРаспознавание идёт локально, на этом компьютере: аудио никуда не уходит, пока вы сами не включите облачного провайдера.$\r$\n$\r$\n$_CLICK"
LangString sottoWelcomeText ${LANG_ENGLISH} "${PRODUCTNAME} turns your speech into text and types it into the active window.$\r$\n$\r$\nRecognition runs locally on this machine: no audio leaves it unless you enable a cloud provider yourself.$\r$\n$\r$\n$_CLICK"

LangString sottoFinishTitle ${LANG_RUSSIAN} "${PRODUCTNAME} установлен"
LangString sottoFinishTitle ${LANG_ENGLISH} "${PRODUCTNAME} is installed"

LangString sottoFinishText ${LANG_RUSSIAN} "Приложение живёт в трее. Горячую клавишу можно изменить в настройках.$\r$\n$\r$\nПри первом запуске нужно будет скачать модель распознавания."
LangString sottoFinishText ${LANG_ENGLISH} "The app lives in the tray. You can change the hotkey in the settings.$\r$\n$\r$\nOn first launch it will ask to download a speech model."
...
LangString sottoMigrated ${LANG_RUSSIAN} "Предыдущая версия удалена, настройки и история сохранены."
LangString sottoMigrated ${LANG_ENGLISH} "Previous version removed; settings and history were kept."

LangString sottoMigrationFailed ${LANG_RUSSIAN} "Не удалось удалить предыдущую версию. Установка продолжится, старую копию уберите вручную через «Приложения и возможности»."
LangString sottoMigrationFailed ${LANG_ENGLISH} "Could not remove the previous version. Setup will continue; remove the old copy manually from Apps & features."
; ─────────────────────────────────────────────────────────────────────────────
